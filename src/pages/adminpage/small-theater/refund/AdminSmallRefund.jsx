...
//소공연환불 Mock Data
export const smallRefundData = [
  {id: "diana8448", name: "전시연", title: "실종", dateTime: "2024.01.25 / 14:00", refundDateTime: "2024.01.24 / 17:59 "},
  {id: "diana8448", name: "전시연", title: "알라딘", dateTime: "2024.01.25 / 14:00", refundDateTime: "2024.01.24 / 17:59 "},
  {id: "diana8448", name: "전시연", title: "알라딘", dateTime: "2024.01.25 / 14:00", refundDateTime: "2024.01.24 / 17:59 "},
  {id: "diana8448", name: "전시연", title: "알라딘", dateTime: "2024.01.25 / 14:00", refundDateTime: "2024.01.24 / 17:59 "},
  {id: "diana8448", name: "전시연", title: "알라딘", dateTime: "2024.01.25 / 14:00", refundDateTime: "2024.01.24 / 17:59 "},
  {id: "diana8448", name: "전시연", title: "알라딘", dateTime: "2024.01.25 / 14:00", refundDateTime: "2024.01.24 / 17:59 "},
...
export const colKeys = ["id", "name", "title", "dateTime", "refundDateTime"];
export const colLabels = ["아이디", "이름", "소극장 공연 이름", "날짜/시간", "환불 날짜/시간"];
export const checkBoxMap = [0, 2, 4]; 
export const checkBoxLabels = ["아이디", "소극장 공연 이름", "환불 날짜/시간"];

export default function AdminSmallRefund() {
  ...
  // 1. 체크박스 기능 ////////////////////////////////////////////////
      ...
      const filteredData = smallRefundData.filter((smallrefund) => {
        if (!searchTerm) return true; // 아무것도 안쳤다면 전체
        const fieldValue = (smallrefund[searchKey] ?? "").toString().toLowerCase();
      ...
      <Data>
        <TableWrapper>
          <StyledTable>
            ...
            <tbody>
              {currentData.map((smallrefund, index) => (
                <tr key={index}>
                  {/* 선택된 컬럼들만 td */}
                  {displayedColIndexes.map((i) => (
                    <td key={colKeys[i]}>{smallrefund[colKeys[i]]}</td>
                  ))}
                  {/* 상세페이지버튼 */}
                  <td>
                    <DetailButton to={`/adminpage/small-theater/refund/detail/${smallrefund.id}`}>상세</DetailButton>
                  </td>
                </tr>
              ))}
            </tbody>
