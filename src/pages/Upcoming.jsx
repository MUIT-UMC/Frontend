...
const LeftArea = styled.div`
  ...
  width: 500px; 
  /* 원하는 폭 조정, 
     여기 안에서 Option들을 absolute( top:% )로 위치시킴 */
`;

/**
 * Option(각 타이틀):
 * ex) style={{ top: "10%" }}로 세로 위치 지정
 * left: 0 / transform etc.로 수평 정렬
 */
...
/** OptionTitle: 활성화시 빨강+80px, 비활성 회색+60px */
...
/**
 * OptionSubTitle: 28px 높이, 가로=OptionTitle 너비,
 * 빨강 배경, 흰색 글씨, 위치= OptionTitle 아래
 */
